...
class VideoStreamController extends Controller
{
    public function stream(Request $request, $filename)
    {
        ...
        // For private videos, check permissions
        ...
        // Use the same streaming mechanism for both public and private videos
        $path = $video->visibility === 'public'
            ? storage_path('app/public/' . $video->file_path)
            : storage_path('app/private/videos/' . $filename);
