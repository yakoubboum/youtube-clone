...
<template>
    <div id="TopNav" class="fixed z-20 flex h-[55px] w-full items-center justify-between px-2 sm:px-6" :class="navBackgroundColor">
        ...
        <div class="flex w-auto min-w-0 flex-shrink-0 items-center">
            ...
            <!-- Logo -->
            <Link href="/" class="flex min-w-0 items-center text-white">
                <div class="flex cursor-pointer items-center justify-center text-white">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        id="yt-ringo2-svg_yt14"
                        class="w-[93px]"
                        height="20"
                        viewBox="0 0 93 20"
                        focusable="false"
            ...
            <div class="flex w-full max-w-[600px]">
                ...
                >
                    <svg
                        ...
                        focusable="false"
                        aria-hidden="true"
                        style="pointer-events: none; display: inherit; width: 55%; height: 65%"
                    >
                        <path
                            clip-rule="evenodd"
        ...
        <div class="flex min-w-0 items-center gap-1 sm:gap-3">
            ...
            <button
                class="flex cursor-pointer items-center justify-center rounded-full bg-[#272727] p-2 px-3 py-1.5 transition-colors hover:bg-[#303030]"
            >
                ...
                <span class="ml-2 font-bold text-white" style="font-family: 'Roboto', Arial, sans-serif">Create</span>
            </button>
